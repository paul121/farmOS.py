...
# https://github.com/encode/httpcore/blob/master/unasync.py
# Subs modified for farmOS.py
# Should we follow the elastic/elasticsearch-py method instead?
# https://github.com/elastic/elasticsearch-py/blob/main/utils/run-unasync.py
